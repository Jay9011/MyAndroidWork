...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Log.d("myapp", "onCreateOptionMenu - 최초 메뉴키를 눌렀을 때 호출됨");
        ...
        return true;    // false 를 리턴하면 메뉴는 보여지지 않는다.
    }
...
//            menu.getItem(1).setEnabled(true);
        ...
        blog = !blog;   // 로그인과 로그아웃을 번갈아 하도록

        return super.onPrepareOptionsMenu(menu);    // false 를 리턴하면 메뉴는 보여지지 않는다.
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MENUITEM_ORANGE:
                ll.setBackgroundResource(R.color.colorOrange);
                break;
            case MENUITEM_CYAN:
                ll.setBackgroundResource(R.color.colorCyan);
                break;
        }
