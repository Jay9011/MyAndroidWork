...
public class Main4Activity extends AppCompatActivity {
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    tvResult.setText("INSERT 실패 : age 는 숫자로 입력해 주세요.");
                }

                insert(name, a, address);
            }
        }); // end btnInsert.setOnClickListener
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    tvResult.setText("UPDATE 실패 : age 는 숫자로 입력해 주세요.");
                }
    ...
    void insert(String name, int age, String address) {
        ...
        // 리턴값은 auto-generated 값
        long result = db.insert(tableName, null, values);

        Log.d("myapp", result + "개 row INSERT 성공");
        tvResult.setText(result + "번 INSERT 성공");
        select();

    } // end insert(String, int, String)
