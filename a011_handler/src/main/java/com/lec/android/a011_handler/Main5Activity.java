...
public class Main5Activity extends AppCompatActivity {
    ...
    class BackgroundTask extends AsyncTask<Integer, Integer, Integer> {
        ...
        // Background 작업 도중 (여러번) 호출 가능, 진행상황 업데이트, 중간중간 UI 업데이트시 사용
        @Override
        ...
        protected void onPostExecute(Integer integer) {     // doInBackground 에서 return 한 값을 매개변수로 받는다.
            ...
            tvBackValue1.setText("onPosetExecute : " + integer);    // ★★★ Handler 없이도 메인 UI 접근가능
        }
    } // end AsyncTask
