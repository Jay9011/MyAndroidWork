...
public class Main3Activity extends AppCompatActivity {
    ...
    // 이미지 경로 알아내기
    // 픽셀폰 : 이미지보기 - 하단의 info 버튼
    // 삼성폰 : 이미지 롱클릭 후 상세정보
    private String imgPath = "/sdcard/DCIM/Camera/drawable/zelda_03.jpg";

    ImageView ivPhoto;
    TextView tvPath;
    Button btnAction;

    private final int PERMISSION_REQUEST_CODE = 101;    // 권한 요청 코드값 (아무 숫자로 지정)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // E/BitmapFactory: Unable to decode stream: java.io.FileNotFoundException: /storage/emulated/0/DCIM/Camera/drawable/zelda_03.jpg: open failed: EACCES (Permission denied)
            }
        });
    ...
    // 권한 획득 결과 처리하는 콜백 메소드
    // requestCode : 권한 요청 코드값
    // permissions : 권한 요청들
    // grantResults : 각 권한에 대한 승인내역들
    @Override
