...
//        unregisterForContextMenu(tvCtxMenu);// 뷰객체(위젯 등...) 에 등록된 ContextMenu 를 제거함
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        int groupId = item.getGroupId();// 메뉴 아이템의 그룹 아이디 값
            ...
            case 1:
                switch (id) {
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        ivCtxMenu.setImageResource(R.drawable.face15);
                        return true;
                }
                break;
        }
