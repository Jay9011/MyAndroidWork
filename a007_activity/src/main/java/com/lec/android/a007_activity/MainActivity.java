...
public class MainActivity extends AppCompatActivity {
    ...
    /** 액티비티가 사용자에게 보여지기 시작할 때(바로직전에) 호출*/
    @Override
    ...
    /** 액티비티가 더 이상 안보여질때 호출되는 메소드
     *  메모리 상황에 따라 호출되지 않을수도 있음.
     */
    @Override
     ...
     * @param outState <-- 액티비티 정보 저장(백업)하여 나중에 onCreate 에서 사용 가능.
     */
    @Override
